                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            <li>
                                <a href="#"
                                ><i class="fa fa-map-marker"></i> г.Бишкек ул.Турусбекова
                                    123</a
                                >
                            </li>
                            <li>
                                <a href="#"
                                ><i class="fa fa-phone"></i> +996 555-00-00-00</a
                                >
                            </li>
                            <li>
                                <a href="#"
                                ><i class="fa fa-envelope-o"></i>electro@email.com</a
                                >
                            </li>
                        </ul>
                    </div>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="footer">
                        ...
                        <ul class="footer-links">
                            ...
                            <li><a href="#">Просмотреть корзину</a></li>
